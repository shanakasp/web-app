      ...
      <div className="flex justify-center items-center border-y-2">
        <div className=" pt-8 max-w-md w-full ">
          <div className="flex gap-2 justify-center">
            <button className="px-4 pt-2 border-b-2 border-emerald-500 text-xl text-[#049c64] bg-emerald-100 font-medium">
              Profile Details
            </button>
            <button className="px-4 pt-2  border-[#979797] border-solid text-xl text-[#979797]  font-medium">
              Saved Jobs
            </button>
          </div>
        </div>
